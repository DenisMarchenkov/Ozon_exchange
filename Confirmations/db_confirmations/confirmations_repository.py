...
class ConfirmationsRepository:
    ...
    def _init_db(self):
        with self._get_conn() as conn:
            ...
            # cur.execute("""
            #     CREATE TABLE confirmation_products_requirements (
            #         id INTEGER PRIMARY KEY AUTOINCREMENT,
            #
            #         confirmation_id INTEGER NOT NULL,
            ...
            #
            #         is_gtd_needed BOOLEAN NOT NULL DEFAULT 0,
            #         is_jw_uin_needed BOOLEAN NOT NULL DEFAULT 0,
            #         is_mandatory_mark_needed BOOLEAN NOT NULL DEFAULT 0,
            #         is_mandatory_mark_possible BOOLEAN NOT NULL DEFAULT 0,
            #         is_rnpt_needed BOOLEAN NOT NULL DEFAULT 0,
            #         is_weight_needed BOOLEAN NOT NULL DEFAULT 0,
            #
            #         weight_min REAL,
            #         weight_max REAL,
            #         has_imei BOOLEAN NOT NULL DEFAULT 0,
            #
            #         created_at TEXT NOT NULL,
            #
            #         FOREIGN KEY (confirmation_id)
            ...
            #             ON DELETE CASCADE,
            #
            #         UNIQUE (posting_number, product_id)
            #     )
            # """)
            #
            # cur.execute("""
            ...
            #         id INTEGER PRIMARY KEY AUTOINCREMENT,
            #
            #         confirmation_product_id INTEGER NOT NULL,
            #         exemplar_id INTEGER NOT NULL,
            #
            #         gtd TEXT,
            #         is_gtd_absent BOOLEAN NOT NULL DEFAULT 0,
            #
            #         rnpt TEXT,
            #         is_rnpt_absent BOOLEAN NOT NULL DEFAULT 0,
            #
            #         weight REAL,
            #
            #         created_at TEXT NOT NULL,
            #
            #         FOREIGN KEY (confirmation_product_id)
            #             REFERENCES confirmation_products_requirements(id)
            #             ON DELETE CASCADE,
            #
            #         UNIQUE (confirmation_product_id, exemplar_id)
            #     )
            # """)
            #
            # cur.execute("""
            #     CREATE TABLE exemplar_marks (
            #         id INTEGER PRIMARY KEY AUTOINCREMENT,
            #
            #         exemplar_id INTEGER NOT NULL,
            #         mark TEXT NOT NULL,
            ...
            #             REFERENCES exemplars(id)
            #             ON DELETE CASCADE,
            #
            #         UNIQUE (exemplar_id, mark)
            #     )
            # """)
